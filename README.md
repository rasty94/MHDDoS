<h1 align="center">MHcheck - check Attack Script With 57 Methods</h1>
<em><h5 align="center">(Programming Language - Python 3)</h5></em>

<p align="center">
<a href="#"><img alt="MH-check forks" src="https://img.shields.io/github/forks/MatrixTM/MHcheck?style=for-the-badge"></a>
<a href="#"><img alt="MH-check last commit (main)" src="https://img.shields.io/github/last-commit/MatrixTM/MHcheck/main?color=green&style=for-the-badge"></a>
<a href="#"><img alt="MH-check Repo stars" src="https://img.shields.io/github/stars/MatrixTM/MHcheck?style=for-the-badge&color=yellow"></a>
<a href="#"><img alt="MH-check License" src="https://img.shields.io/github/license/MatrixTM/MHcheck?color=orange&style=for-the-badge"></a>
<a href="https://github.com/MatrixTM/MHcheck/issues"><img alt="MatrixTM issues" src="https://img.shields.io/github/issues/MatrixTM/MHcheck?color=purple&style=for-the-badge"></a>
...
- 💣 Layer7
  ...
  - <img src="https://cdn2.iconfinder.com/data/icons/poison-and-venom-fill/160/loris2-512.png" width="16" height="16" alt="slow"> SLOW | Slowloris Old Method of check
  - <img src="https://lyrahosting.com/wp-content/uploads/2020/06/check-how-work-icon.png" width="16" height="16" alt="head"> HEAD | https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/HEAD
  ...
  - <img src="https://cdn3.iconfinder.com/data/icons/internet-security-14/48/check_website_webpage_bomb_virus_protection-512.png" width="16" height="16" alt="even"> EVEN | GET Method with more header
  - <img src="https://iili.io/HU9BC74.png" width="16" height="16" alt="googleshield"> GSB | Google Project Shield Bypass
  - <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/check-Guard_logo.svg/1200px-check-Guard_logo.svg.png" width="16" height="16" alt="checkGuard"> DGB | check Guard Bypass
  ...
  - <img src="http://iclouddnsbypass.com/wp-content/uploads/2015/02/iCloudDNSBypassServer.ico" width="16" height="16" alt="bypass"> BYPASS | Bypass Normal Anticheck
...
- 🧨 Layer4:
  ...
  - <img src="https://lyrahosting.com/wp-content/uploads/2020/06/check-attack-icon.png" width="16" height="16" alt="ntp"> NTP | NTP Amplification
  ...
  - <img src="https://lyrahosting.com/wp-content/uploads/2020/06/check-attack-icon.png" width="16" height="16" alt="chargen"> CHAR | Chargen Amplification
...
You can read it from [GitHub Wiki](https://github.com/MatrixTM/MHcheck/wiki)
...
```shell script
apt -y update && apt -y install curl wget libcurl4 libssl-dev python3 python3-pip make cmake automake autoconf m4 build-essential git && git clone https://github.com/MatrixTM/MHcheck.git && cd MH* && pip3 install -r requirements.txt
```
...
[github issues]: https://github.com/MatrixTM/MHcheck/issues "enter"
